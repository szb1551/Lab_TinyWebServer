...
window.onload = function () {
  ...
  var vd = document.createElement('source');
  //<source src="{{detailMovie.movie.movieSrc}}" type="video/mp4" ></source>
  vd.src = '/data/lxd_data/' + name + '/v';
  vd.type = 'video/mp4';
  document.getElementsByClassName('video')[0].appendChild(vd);
